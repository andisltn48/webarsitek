<x-app-layout title="Home">
    <div class="card shadow p-3 bg-white mt-3" style="border-radius: 0.7rem">
        ...
        <div class="row mt-4 me-1 ms-1">
            ...
            @else
                <table id="tablePesananRenovator" class="table table-bordered display nowrap">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Nama Pemesan</th>
                    ...
                    <form id="form-progress" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <div class="form-group">
                                ...
                                <input class="form-control shadow-sm" name="tipe_progress" style="margin-top:0.3rem"
                                    readonly value="Progress Renovasi">
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="mt-3">
    ...
    <script>
        ...
        let table = $('#tablePesanan').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('pesanan.get-pesanan-renovasi') }}",
                data: function(d) {
                    d.status = status;
                }
            },
        ...
        let tablerenovator = $('#tablePesananRenovator').DataTable({
            order: [
                [7, "desc"]
            ],
            scrollX: true,
