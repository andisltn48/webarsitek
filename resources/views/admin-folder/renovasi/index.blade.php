<x-app-layout title="Daftar Desain">
    <div class="d-flex row-desain">
        <div class="card shadow p-3 bg-white m-2" style="border-radius: 0.7rem; max-width:50rem !important">
            ...
            <div class="row">
                <div class="col-12 col-md-8 title">
                    <h5 class="fw-bold">Daftar Item Renovasi</h5>
                </div>
            </div>
            <hr>
            <div class="row mt-4 me-1 ms-1">
                <table id="tableItem" class="table table-bordered nowrap" >
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Nama Item</th>
        ...
        <div class="col card shadow p-3 bg-white m-2" style="border-radius: 0.7rem;max-height: 45rem !important">
            ...
            <hr>
            <form enctype="multipart/form-data" class="mt-2 p-2" action="{{ route('renovasi.store') }}"
                method="post">
                @csrf
                <div class="mb-3">
                    <div class="form-group">
                        <label style="margin-bottom:10px" class="text-dark fw">Nama Item<sup
                                class="text-danger">*</sup></label>
                        <div class="form-group">
                            <input class="form-control shadow-sm" name="nama_item" value="{{ old('nama_item') }}"
                                style="" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    <div class="mt-3">
                        <label for="exampleFormControlInput1">Gambar Item<sup class="text-danger">*</sup></label>
                        <div class="custom-file">
                            <input multiple accept="image/*" required class="form-control-file" name="gambar_item[]"
                                type="file">
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        let table = $('#tableItem').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('renovasi.get-renovasi') }}",
            },
            columns: [{
                data: 'DT_RowIndex',
                name: 'DT_Row_Index',
